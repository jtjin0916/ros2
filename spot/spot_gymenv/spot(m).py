...
#SPOT_MINI_MINI
NEW_LEG_POSITION = ["front_left", "front_right", "back_left", "back_right"]
NEW_MOTOR_NAMES = [
...
NEW_MOTOR_LIMITS_BY_NAME = {}
for name in NEW_MOTOR_NAMES:
    if "hip" in name:
        NEW_MOTOR_LIMITS_BY_NAME[name] = [-1.04, 1.04]
    elif "upper_leg" in name:
        NEW_MOTOR_LIMITS_BY_NAME[name] = [-1.571, 2.59]
    elif "lower_leg" in name:
        NEW_MOTOR_LIMITS_BY_NAME[name] = [-2.9, 1.671]
