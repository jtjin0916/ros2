...
from spot_gymenv import spot
import pybullet_utils.bullet_client as bullet_client
from spot_gymenv.OpenLoopSM.SpotOL import BezierStepper
from spot_gymenv.spot_gym_env import spotGymEnv
import spot.Kinematics.LieAlgebra as LA
from spot_gymenv.spot_env_randomizer import SpotEnvRandomizer
...
register(
    id="SpotMicroEnv-v1",
    entry_point='qr_gymenv.GymEnvs.qr_bezier_env:spotBezierEnv',
...
#비주얼 건들이기?
    ...
    """
        ...
        info = {}
        # gymnasium이면 5-return, gym이면 4-return
        if gym.__name__ == "gymnasium":
            terminated = bool(done)
            truncated = False  # 너는 time limit 처리 따로 안 하고 있으니 일단 False
